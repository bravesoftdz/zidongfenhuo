  ...
  begin
    ...
    Form3.RzProgressBar1.PartsComplete:=k-2;
      ...
      begin
        ...
        begin
           if Trim(ExcelApp2.Cells[j,yipeihuoliangCol].Value) = '' then
           begin
              ExcelApp2.Cells[j,yipeihuoliangCol].Value:= Trim(ExcelApp1.Cells[k,strtoint(dinghuorenCol.ValueFromIndex[i])].Value);
           ...
           begin
              ExcelApp2.Cells[j,yipeihuoliangCol].Value:= inttostr(strtoint(Trim(ExcelApp1.Cells[k,strtoint(dinghuorenCol.ValueFromIndex[i])].Value)) + strtoint(Trim(ExcelApp2.Cells[j,yipeihuoliangCol].Value)));
              ExcelApp2.Cells[j,dinghuoListShuLiangCol].Value:=inttostr(strtoint(Trim(ExcelApp2.Cells[j,dinghuoListShuLiangCol].Value)) - strtoint(Trim(ExcelApp2.Cells[j,yipeihuoliangCol].Value)));
              break;
           end;
        end;
